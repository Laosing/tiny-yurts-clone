...
export const gridCellSize = 8; // Width & height of a cell, in pixels

// Offset of buildable area inside the game board
// (this could change at the start of the game before zooming out?)
export const boardOffsetX = 3;
export const boardOffsetY = 2;

// Number of cells making up width and height of game board, only including buildable area
...
// Number of cells making up width and height of game board, including non-buildable area
...
// Inlined grid color (#0001) to use fewer bytes
...
svgHazardLines.style.transition = 'opacity 0.3s';
...
svgHazardLinesRed.style.transition = 'opacity 0.3s';

svgContainerElement.append(svgHazardLines, svgHazardLinesRed);

// Initial SVG element
export const svgElement = createSvgElement('svg');
// touch-action: none is required to prevent default dragging, probably
