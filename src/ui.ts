...
export const pauseButton = createElement('button') as HTMLButtonElement;
export const pauseSvgPath = createSvgElement('path') as SVGPathElement;

// Odd one out because can't put divs in an svg
export const clockHand = createSvgElement('path') as SVGPathElement;

export const gridToggleButton = createElement('button') as HTMLButtonElement;
export const gridToggleSvg = createSvgElement('svg') as SVGSVGElement;
export const gridToggleSvgPath = createSvgElement('path') as SVGPathElement;
export const gridToggleTooltip = createElement();

export const gridRedToggleButton = createElement('button') as HTMLButtonElement;
export const gridRedToggleSvg = createSvgElement('svg') as SVGSVGElement;
export const gridRedToggleSvgPath = createSvgElement('path') as SVGPathElement;
export const gridRedToggleTooltip = createElement();

export const soundToggleButton = createElement('button') as HTMLButtonElement;
export const soundToggleSvg = createSvgElement('svg') as SVGSVGElement;
export const soundToggleSvgPath = createSvgElement('path') as SVGPathElement;
export const soundToggleSvgPathX = createSvgElement('path') as SVGPathElement;
...
export const initUi = () => {
  ...
  const clockSvg = createSvgElement('svg') as SVGSVGElement;
  ...
  for (let i = 75; i < 350; i += 25) {
    const dot = createSvgElement('path') as SVGPathElement;
  ...
  const pathTilesSvg = createSvgElement('svg') as SVGSVGElement;
  ...
  const pathTilesSvgPath = createSvgElement('path') as SVGPathElement;
  ...
  const pauseSvg = createSvgElement('svg') as SVGSVGElement;
